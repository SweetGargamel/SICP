...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self):
        ...
        while (not front_place.is_hive):
            if((front_place.bees) and (count>=self.min_range and count<=self.max_range)):
                return random_bee(front_place.bees)
            count=count+1
...
class QueenAnt(ScubaThrower):  # You should change this line
    ...
    def construct(cls, gamestate):
        ...
        """
        # BEGIN PROBLEM 12
        if hasattr(gamestate,'has_queen'):
            return None
        else:
...
class Bee(Insect):
    ...
    def action(self, gamestate):
        ...
        if self.blocked():
            ...
            if (self.slow_countdown == 0 or gamestate.time % 2 == 0): 
